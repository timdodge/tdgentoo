...
inherit eutils-local fixheadtails flag-o-matic gnuconfig libtool multilib pax-utils toolchain-funcs prefix
...
toolchain-local_src_prepare() {
	...
	case ${EAPI:-0} in
		5*) epatch_user;;
		6|7) eapply_user ;;
		*) die "Update toolchain-local_src_prepare() for ${EAPI}." ;;
	esac
...
has toolchain-local_death_notice ${EBUILD_DEATH_HOOKS} || EBUILD_DEATH_HOOKS+=" toolchain-local_death_notice"
toolchain-local_death_notice() {
