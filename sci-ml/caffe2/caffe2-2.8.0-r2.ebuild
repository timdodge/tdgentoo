...
CK_COMMIT=4c57157d508e4c102626730aa372c8111670a878
...
RDEPEND="
	...
	rocm? (
		>=dev-libs/rccl-6.1      <dev-libs/rccl-7.5
		>=dev-util/hip-6.1       <dev-util/hip-7.5
		>=dev-util/roctracer-6.1 <dev-util/roctracer-7.5
		>=sci-libs/hipBLAS-6.1   <sci-libs/hipBLAS-7.5
		>=sci-libs/hipBLASLt-6.1 <sci-libs/hipBLASLt-7.5
		>=sci-libs/hipCUB-6.1    <sci-libs/hipCUB-7.5
		>=sci-libs/hipFFT-6.1    <sci-libs/hipFFT-7.5
		>=sci-libs/hipRAND-6.1   <sci-libs/hipRAND-7.5
		>=sci-libs/hipSOLVER-6.1 <sci-libs/hipSOLVER-7.5
		>=sci-libs/hipSPARSE-6.1 <sci-libs/hipSPARSE-7.5
		>=sci-libs/miopen-6.1    <sci-libs/miopen-7.5
		>=sci-libs/rocPRIM-6.1   <sci-libs/rocPRIM-7.5
		>=sci-libs/rocThrust-6.1 <sci-libs/rocThrust-7.5
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2.8.0-remove-use-of-warpsize.patch
)
